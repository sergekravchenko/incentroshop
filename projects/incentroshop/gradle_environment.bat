...
SET WORKSPACE=%USERPROFILE%\incentroshop\workspace
...
SET ORG_GRADLE_PROJECT_buildEnvironmentPropertiesSample=%USERPROFILE%\incentroshop\environment.properties.sample
