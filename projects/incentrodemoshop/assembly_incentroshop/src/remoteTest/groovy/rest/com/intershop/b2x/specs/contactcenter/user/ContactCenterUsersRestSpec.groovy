package rest.com.intershop.b2x.specs.contactcenter.user
...
class ContactCenterUsersRestSpec extends RestSpec
{
    ...
    def setupSpec()
    {
        setup:
            ...
            restServiceUri = testData.get("rest.contactCenter.uri.ish")[0] + "/users"
    ...
    @Unroll
    def "Check Logged in Admin User Sees Users using contentType #contentType"()
    {
        given:
        ...
        then:
            ...
            assertType(response.data, "User", contentType);
