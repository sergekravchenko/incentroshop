package rest.com.intershop.b2x.specs.contactcenter.customer
...
class ContactCenterCustomersRestSpec extends RestSpec
{
    ...
    def setupSpec()
    {
        setup:
            ...
            String searchFieldName  = testData.get('contactCenter.search.fieldName')[0]
            String searchFieldValue = testData.get('contactCenter.search.fieldValue')[0]
            String searchParameters = "?${searchFieldName}=${searchFieldValue}"

            restServiceUri = testData.get("rest.contactCenter.uri.ish")[0] + "/customers" + searchParameters
    ...
    @Unroll
    def "Check Logged in Admin User Sees Customers using contentType #contentType"()
    {
        given:
