 ...
 */
public class GetPriceChangeNotifications extends Pipelet
{
    @Inject
    ...
    */
        ...
        throws PipeletExecutionException
    {
        ...
        while( alerts.hasNext() )
        {
            ...
            if( alert.getHandlerClassName().equalsIgnoreCase("com.intershop.component.mvc.capi.alert.PriceConditionHandler") )
            {
                result.add(alert);
            }
        }
